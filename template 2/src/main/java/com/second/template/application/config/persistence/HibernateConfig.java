package com.second.template.application.config.persistence;
...
@EnableJpaRepositories("com.second.template.application.repositories")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.second.template.application.model");
                for (Class<?> clazz : (new Reflections("com.second.template.application.model")).getTypesAnnotatedWith(Entity.class)) {
